...
define('WCL_THEME_VERSION', '0.217');
...
*/
add_image_size('image-size-1', 1920, 1000, true);
add_image_size('image-size-1@2x', 3840, 2000, true);
add_image_size('image-size-2', 317, 313, true);
add_image_size('image-size-2@2x', 634, 626, true);
add_image_size('image-size-3', 426, 564, true);
add_image_size('image-size-3@2x', 852, 1128, true);
add_image_size('image-size-4', 1920, 550, true);
add_image_size('image-size-4@2x', 3840, 1100, true);
add_image_size('image-size-5', 317, 350, true);
add_image_size('image-size-5@2x', 634, 700, true);
add_image_size('image-size-6', 351, 225, true);
add_image_size('image-size-6@2x', 702, 450, true);
add_image_size('image-size-7', 856, 360, true);
add_image_size('image-size-7@2x', 1712, 720, true);
add_image_size('image-size-8', 351, 225, true);
add_image_size('image-size-8@2x', 702, 450, true);
add_image_size('image-size-9', 856, 550, true);
add_image_size('image-size-9@2x', 1712, 1100, true);
add_image_size('image-size-10', 416, 236, true);
add_image_size('image-size-10@2x', 832, 472, true);
