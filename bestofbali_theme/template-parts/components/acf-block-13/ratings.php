...
<?php if (!empty($ratings)) : ?>
    <div class="wcl-block-3 data-head-rating js-target">
        <div class="q3-rating-out">
            <div class="q3-rating">
                <div class="q3-rating-list">
                    <?php foreach ($ratings as $key => $item) : ?>
                        ...
                        <?php if (!empty($item_value)) : ?>
                            <div class="q3-rating-item <?php echo $class; ?>">
                                <div class="q3-rating-item-title">
                                    <?php echo $item_title; ?>
                                </div>

                                <div class="q3-rating-item-score">
                                    <?php
                                    if ($item_name == 'trip-advisor') {
                                        for ($i = 1; $i <= 5; $i++) {
                                            if ($i <= $item_value) {
