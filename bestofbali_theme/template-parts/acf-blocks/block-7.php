...
?>
<!-- Acf Block #7 - Bali’s Top Upcomig Events -->
<div class="wcl-acf-block-7 wcl-section <?php echo $slider_class; ?>">
    <div class="data-imgs">
        <img src="<?php echo get_stylesheet_directory_uri() . '/img/acf_7_cloud.png'; ?>" alt="img">
    </div>
