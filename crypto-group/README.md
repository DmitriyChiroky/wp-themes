...
- **Оформление заказа:** Процесс оформления заказа.
- **Главная:** Основная страница с ключевыми предложениями.
- **Список видео:** Страница, посвященная видеоматериалам.
- **Личный кабинет:** Личный кабинет для управления подписками и настройками.
- **Политика конфиденциальности:** Описание практик конфиденциальности сайта.
- **Условия возврата и обмена:** Политика возвратов и обменов.
- **Магазин:** Раздел для просмотра и покупки товаров.
