...
define('WCL_THEME_VERSION', '0.157');
...
function wcl_theme_enqueue_scripts() {
	...
	wp_enqueue_script('wcl-masonry', get_template_directory_uri() . '/js/masonry.pkgd.min.js', array(), '4.2.2', true);
...
*/
add_image_size('image-size-1', 520, 0, false);
add_image_size('image-size-1@2x', 1040, 0, false);
add_image_size('image-size-2', 150, 0, false);
add_image_size('image-size-2@2x', 300, 0, false);
...
function wcl_register_nav_menus() {
	...
	register_nav_menu('menu-active-members', 'Menu Active Members');
	register_nav_menu('menu-unactive-members', 'Menu Unactive Members');
	register_nav_menu('menu-logged-out-members', 'Menu Logged Out Members');
}
