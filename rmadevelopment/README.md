...
- **Logo Light** — Логотип для светлой версии сайта.
- **Logo Dark** — Логотип для тёмной версии сайта.
- **Phone** — Контактный телефон компании.
- **Email** — Адрес электронной почты.
- **Address** — Физический адрес компании.
- **Contact Info** — Дополнительная контактная информация.
- **Footer Copyright** — Текст авторских прав в подвале сайта.
