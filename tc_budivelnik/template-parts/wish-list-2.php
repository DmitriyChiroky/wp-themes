...
if (is_user_logged_in()) {
    $wishlist_items = get_user_meta(get_current_user_id(), 'wishlist', true);
} else {
    if (isset($_COOKIE['wishlist'])) {
        $wishlist_items = json_decode(stripslashes($_COOKIE['wishlist']), true);
    }
}
...
?>
<div class="wcl-wish-list mod-v2">
