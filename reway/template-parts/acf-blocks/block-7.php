...
?>
<!-- Acf Block #7 – Contact Us - Discover Our Secret World -->
<div class="wcl-acf-block-7" itemscope itemtype="https://schema.org/Article">
    <div class="data-container wcl-container">
        ...
        <?php if (!empty($bg_image)) : ?>
            <div class="data-bg-image" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
                <?php echo str_replace('<img ', '<img itemprop="url" ', $bg_image); ?>
            </div>
        <?php endif; ?>
    </div>
</div>